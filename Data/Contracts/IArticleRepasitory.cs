...
namespace Data.Contracts
{
    public interface IArticleRepasitory :  IRepository<Article>
    {
        ...
        ListArticleDto GetListArticle(int PageNum = 1, int PageSize = 12);
      ...
      //  List<Article> GetListArticleById(int articleId);
        ...
        ListArticleDto GetListArticlesByArticleCategoryId(int articleCategoryId , int PageNum = 1, int PageSize = 0);
