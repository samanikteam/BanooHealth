...
namespace Data.Migrations
{
    ...
    [Migration("20220819221411_mig_add-parentId-in-comment")]
    partial class mig_addparentIdincomment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Articles.ArticleCategoryAssign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ArticleCategoryAssigns");
                });
            ...
            modelBuilder.Entity("Entities.Common.About", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Common.Call", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Common.Contactus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Common.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Products.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Products.ProductFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Products.ProductFilter", b =>
                {
                    b.HasOne("Entities.Products.Filter", "filter")
                        .WithMany()
